 ...
 */
public class ColorInputView extends DataFlowView{
    // radii
    ...
    private ColorPicker field = new ColorPicker();

    private ColorInputNode colorInputNode;

    public ColorInputView(ColorInputNode colorInputNode, DataFlowViewListener dataFlowViewListener) {
        super(dataFlowViewListener);
        this.colorInputNode = colorInputNode;
        initialize();
    }
    ...
    private void initialize(){
        ...
        this.setTranslateX(colorInputNode.getX());
        this.setTranslateY(colorInputNode.getY());
